import 'package:layout/entity/detail_model.dart';
...
class RowEntity{
  ...
  RowEntity({this.pickListCode, this.storeEtonCode, this.pickedQty, this.qty, this.tote, this.isFinish, this.detail});
